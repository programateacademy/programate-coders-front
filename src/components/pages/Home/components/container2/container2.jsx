      ...
      <div className="cont-info-container2">
        <div className="info1-container2">
          <div className="img1-container2">
            ...
            <img
              ...
              alt=""
              className="img-info1-container2"
            />
          </div>
          <div className="text-container2">
            ...
            <p>
              ...
              <span> del lenguaje del mercado más esencial</span>
            </p>
            <h3>Academy</h3>
          </div>
        </div>
        <div className="info1-container2">
          <div className="img1-container2">
            ...
            <img
              src={
                new URL(
                  `../../../../../assets/Imagenes/Vectary texture.svg`,
                  import.meta.url
                ).href
              }
              alt=""
          ...
          <div className="text-container2">
            <h2>CSS</h2>
            <p>
              Da vida a tus páginas <span> web con estilos únicos</span>
            </p>
            <h3>School</h3>
          </div>
        </div>
        <div className="info1-container2">
          ...
          <div className="text-container2">
            <h2>JavaScript</h2>
            <p>
              <span>Aprende a</span> crear interactividad y dinamismo
              <span> en tus proyectos</span>
            </p>
            <h3>Academy</h3>
          </div>
        </div>
      </div>
      <Link className="button-container2" to="/programas">
        <Button className="button-primary">¡Explora más Cursos!</Button>
      </Link>
    </div>
  );
}
